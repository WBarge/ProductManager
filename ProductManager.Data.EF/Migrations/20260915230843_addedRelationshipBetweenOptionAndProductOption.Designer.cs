...
namespace ProductManager.Data.EF.Migrations
{
    ...
    [Migration("20260915230843_addedRelationshipBetweenOptionAndProductOption")]
    partial class addedRelationshipBetweenOptionAndProductOption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductManager.Data.EF.Model.Characteristic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ProductManager.Data.EF.Model.CharacteristicValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CharacteristicValue", (string)null);
                });

            modelBuilder.Entity("ProductManager.Data.EF.Model.Option", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProductManager.Data.EF.Model.CharacteristicValue", b =>
                {
                    b.HasOne("ProductManager.Data.EF.Model.Characteristic", "Characteristic")
                        .WithMany("Values")
            ...
            modelBuilder.Entity("ProductManager.Data.EF.Model.ProductOption", b =>
                {
                    b.HasOne("ProductManager.Data.EF.Model.Option", "Option")
                        .WithMany()
